...
const DashboardLayout = () => {
  ...
  const marginLeft = collapsed ? "ml-14" : "ml-64";
  ...
  return (
    <div className="min-h-screen flex w-full bg-background">
      {/* Sidebar dinamica */}
      <div className={`fixed left-0 top-0 h-screen ${sidebarWidth} z-40 transition-all duration-300`}>
        <DashboardSidebar 
          user={user}
          profile={profile}
      ...
      {/* Contenuto principale che si adatta alla sidebar */}
